...
<html>
          ...
          $('.likeBtn').click(function(){         
            ...
            $.ajax({
              ...
              complete : function(data) {
                 window.location.replace("publicOutfits.php");
              }
            }); 
          });
        });
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Bouge</span></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">               
                      <li class="nav-item"><a class="nav-link" href="logout.php"> <i class="fas fa-dolly-flatbed me-1 text-gray"></i>Cart<small class="text-gray fw-normal">(2)</small></a></li>
        ...
        <header class="text-center">
          <h2 class="h5 text-uppercase mb-4">Public Outfits</h2>
          </header>
        <div class="row">
            <?php
            for ($x = 0; $x < count($oArray); $x++) {
                ...
                <br>
                <a class="btn likeBtn" data-oName="'.$oArray['prod'.$x]['outfitName']['name'].'">Like</a>
                <a class="btn dislikeBtn" data-oName="'.$oArray['prod'.$x]['outfitName']['name'].'">Dislike</a>
                </div>';
            }
            ?>
